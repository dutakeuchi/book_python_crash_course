...
class EletricCar(Car):
    ...
    def __init__(self, make, model, year):
        ...
        self.battery_car = Battery()
# %%
my_eletric_car = EletricCar('nissan','leaf',2025)
my_eletric_car.info_car()
# %%
my_eletric_car.battery_car.describe_battery()
my_eletric_car.battery_car.driving_range()
# %%
my_eletric_car.battery_car.battery_size = 100
my_eletric_car.battery_car.driving_range()
# %%
